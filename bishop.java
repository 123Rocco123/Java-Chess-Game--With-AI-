...
class bishop extends Pieces {
  ...
  public boolean allowedMoves(int newRow, int newColumn) {
    ...
    for (int i = 1; i < 9; i++) {
      ...
      if ((newRow == (this.row + i)) && (newColumn == this.column + i) && this.chessBoard[(this.row + i)][this.column + i].equals("|__|")) {
        this.row = newRow;
        this.column = newColumn;

        return true;
      } // Move up and to the left
      else if ((newRow == (this.row + i)) && (newColumn == this.column - i) && this.chessBoard[(this.row + i)][this.column - i].equals("|__|")) {
        this.row = newRow;
        this.column = newColumn;
